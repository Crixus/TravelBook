			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="dateCreation" title="${message(code: 'album.dateCreation.label', default: 'Date Creation')}" />
					
						<g:sortableColumn property="dateModification" title="${message(code: 'album.dateModification.label', default: 'Date Modification')}" />
					
						<th><g:message code="album.travel.label" default="Travel" /></th>
				...
				<g:each in="${albumInstanceList}" status="i" var="albumInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${albumInstance.dateCreation}" /></td>
					
						<td><g:formatDate date="${albumInstance.dateModification}" /></td>
					
						<td>${fieldValue(bean: albumInstance, field: "travel")}</td>
