	...
	<body>
		...
		<div id="show-picture" class="content scaffold-show" role="main">
			...
			<ol class="property-list picture">
				...
				<g:if test="${pictureInstance?.image}">
				<li class="fieldcontain">
					<span id="image-label" class="property-label"><g:message code="picture.image.label" default="Image" /></span>
				...
				<g:if test="${pictureInstance?.album}">
				<li class="fieldcontain">
					<span id="album-label" class="property-label"><g:message code="picture.album.label" default="Album" /></span>
					
						<span class="property-value" aria-labelledby="album-label"><g:link controller="album" action="show" id="${pictureInstance?.album?.id}">${pictureInstance?.album?.encodeAsHTML()}</g:link></span>
